...
final class AudioRecordChallengeModel: Identifiable, Hashable, AudioRecordProtocol {
    ...
    func toRecord() -> CKRecord {
        let record = CKRecord(recordType: "AudioRecordChallenge", recordID: id)
    ...
    static func ==(lhs: AudioRecordChallengeModel, rhs: AudioRecordChallengeModel) -> Bool {
        lhs.id == rhs.id
    }
